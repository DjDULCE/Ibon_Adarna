return {
    ...
    },
    {
        name = "Don Juan",
        side = "left",
        "Ang pangalan ko po ay Juan, dumanas ng pagod, puyat, gutom, uhaw at hirap sa aking paglalakbay upang makamit ang matamis na awitin ng Ibong Adarna na siyang lunas sa sakit ng aking ama.",
        "Ikinababahala ng aking kalooban na baka ikamatay ng aking ama ang sakit nito kapag hindi agarang malunasan. Kaya ngayon po ay humihingi sa inyo ng pangaral tungkol sa ibong aking sadya.",
    },
    {
        name = "Ermitanyo",
        side = "right",
    ...
    },
    {
        name = "Don Juan",
        side = "left",
        "Salamat sa inyong bigay na labaha't pitong dayap gayundin sa inyong babala. Tiyak na sa pagbabalik, Ibong Adarna ay akin nang nahuli.",
    },
}
